...
The user should immediately understand: this is a strip of film.
...
Canvas/WebGL is not required for V1.
...
The goal is to make adding text, button, image, new frame, or milestone easy and predictable.
